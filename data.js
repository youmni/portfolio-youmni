...
export const skills = {
  hardskills: [
    { name: "Java", icon: FaJava, color: "#9a8c98" },
    { name: "Javascript", icon: SiJavascript, color: "#9a8c98" },
    { name: "Spring Boot", icon: SiSpringboot, color: "#9a8c98" },
    { name: "ReactJS", icon: SiReact, color: "#9a8c98" },
    { name: "Node.js", icon: SiNodedotjs, color: "#9a8c98" },
    { name: "Express.js", icon: SiExpress, color: "#9a8c98" },
    { name: "Laravel", icon: SiLaravel, color: "#9a8c98" },
    { name: "PHP", icon: SiPhp, color: "#9a8c98" },
    { name: ".NET", icon: SiDotnet, color: "#9a8c98" },
    { name: "Tailwind CSS", icon: SiTailwindcss, color: "#9a8c98" },
    { name: "HTML", icon: SiHtml5, color: "#9a8c98" },
    { name: "CSS", icon: SiCss3, color: "#9a8c98" },
    { name: "MySQL", icon: SiMysql, color: "#9a8c98" },
    { name: "Git", icon: SiGit, color: "#9a8c98" },
  ],
  softskills: [
    { name: "Communication", icon: FaBullhorn, color: "#c9ada7" },
    { name: "Problem Solving", icon: FaBrain, color: "#c9ada7" },
    { name: "Teamwork", icon: FaHandshake, color: "#c9ada7" },
    { name: "Creative Thinking", icon: FaLightbulb, color: "#c9ada7" },
  ],
};
